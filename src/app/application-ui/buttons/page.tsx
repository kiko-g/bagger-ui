  ...
  return (
    <ComponentTypePage
      ...
      components={[
        ...
        { name: "Simple w/ Icon", path: `${base}/ButtonSimpleIcon.tsx`, component: <ButtonSimpleIcon /> },
        ...
        { name: "Fill Animation", path: `${base}/ButtonFill.tsx`, component: <ButtonFill /> },
        { name: "Scale Animation", path: `${base}/ButtonScale.tsx`, component: <ButtonScale /> },
        { name: "Rotate Animation", path: `${base}/ButtonRotate.tsx`, component: <ButtonRotate /> },
        { name: "Translate Animation", path: `${base}/ButtonTranslate.tsx`, component: <ButtonTranslate /> },
      ]}
    />
  )
}
