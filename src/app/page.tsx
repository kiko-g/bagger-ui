...
function SectionCard({ title, count, description, link, image }: SectionCardProps) {
  return (
    <Link
      href={link}
      className="flex flex-1 flex-col border border-slate-300/80 bg-white px-4 py-4 text-white transition-all group-hover:bg-primary-50 hover:border-primary-600 dark:border-slate-100/20 dark:bg-primary-600/20 dark:group-hover:bg-primary-600/40 dark:hover:border-primary-600 xl:px-3 xl:py-3"
    >
      {image ? (
        <Image
          src={image}
        ...
        <div className="aspect-[8/5] w-full border border-primary-800 bg-primary-700 transition group-hover:border-primary-700 group-hover:bg-primary-700 dark:border-white/5 dark:bg-primary-600/50 dark:group-hover:border-primary-800 dark:group-hover:bg-primary-600" />
      )}
