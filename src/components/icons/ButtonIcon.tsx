...
export function ButtonIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" {...props}>
