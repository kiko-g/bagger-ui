...
export function WorkInProgressBadge() {
  return (
    <div className="flex items-center justify-center gap-1.5 rounded-sm bg-transparent px-2 py-1.5 text-2xs font-normal leading-none transition dark:bg-amber-600/20">
