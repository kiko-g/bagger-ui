...
export function QuickNavSidebar({ navigation }: { navigation?: QuickNavigation }) {
  ...
  return (
    <nav className="bg-opacity-80 fixed top-14 z-30 hidden h-[calc(100vh-3.5rem)] min-w-64 shrink-0 flex-col space-y-4 self-stretch overflow-auto py-8 pr-6 pl-4 hover:overflow-auto md:sticky md:block lg:flex lg:border-zinc-900/10 dark:lg:border-white/10">
