...
export function Footer() {
  return (
    <footer className="mx-auto flex w-full items-center justify-between space-x-2 border-t border-zinc-900/10 bg-zinc-800 px-4 py-4 pt-4 backdrop-blur-xl dark:border-white/10 dark:bg-zinc-900 sm:px-6 lg:px-8 lg:py-8 lg:pt-8">
