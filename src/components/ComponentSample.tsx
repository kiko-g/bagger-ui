        ...
        {steps.map((step) => (
          <li key={step.number} className="flex gap-3">
            <div className="flex flex-col items-center gap-1.5">
              <span className="mt-1 flex size-5 min-w-5 items-center justify-center rounded-full border border-zinc-800 bg-zinc-800 text-center font-mono text-xs font-bold text-white dark:bg-zinc-100 dark:text-zinc-800">
                {step.number}
              </span>
